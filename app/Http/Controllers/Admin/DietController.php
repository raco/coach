...
class DietController extends Controller
{
    ...
    {
        $diets = Diet::all();
        return view('admin.pages.diets.index', compact('diets'));
    }
    ...
    {
        $clients = Client::all();
        return view('admin.pages.diets.create', compact('clients'));
    }
    ...
    {
        $clients = Client::all();
        return view('admin.pages.diets.edit', compact('diet', 'clients'));
    }
