...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ route('coach.client.list') }}">Clientes</a>
            </li>
            <li class="active">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('coach.task.delete', $task->id) }}" method="POST">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
...
@push('scripts')
    ...
    <script>
    function crear() {
        $('#myModal .modal-content').load("{{ route('coach.task.create', $id) }}");
    }
    function editar(id) {
        $('#myModal .modal-content').load("/coach/tasks/edit/" + id);
    }
    </script>
